...
<html lang="zxx">
   <head>
      <meta charset="utf-8">
      <title>SHINGAVI JEWELLERS</title>
      <meta name="description" content="Morden Bootstrap HTML5 Template">
      <meta name="viewport" content="width=device-width, initial-scale=1">
      <link rel="shortcut icon" type="image/x-icon" href="https://www.shingavijewellers.com/image/logoblack4.png">
      <!-- ======= All CSS Plugins here ======== -->
      <link rel="stylesheet" href="<?= base_url() ?>public/user_assets/assets/css/plugins/swiper-bundle.min.css">
      <link rel="stylesheet" href="<?= base_url() ?>public/user_assets/assets/css/plugins/glightbox.min.css">
         ...
         <div id="ctn-preloader" class="ctn-preloader">
            <div class="animation-preloader">
               <div class="txt-loading">
                  <img src="https://www.shingavijewellers.com/image/logoblack4.png" style="height:150px;width:150px" alt="">
               </div>
            </div>
      ...
      <header class="header__section">
         <div class="header__topbar bg__secondary">
            <div class="container-fluid">
               <div class="header__topbar--inner d-flex align-items-center justify-content-between" style="height:2vh">
                  <div class="header__shipping">
                     <ul class="header__shipping--wrapper d-flex">
                        <li class="header__shipping--text text-white">Welcome to the Shingavi Jewellery Store ! </li>
                        <li class="header__shipping--text text-white d-sm-2-none">
                           <!-- <img class="header__shipping--text__icon" src="<?= base_url() ?>public/user_assets/assets/img/icon/bus.png" alt="bus-icon">  -->
                           <i class="ri-graduation-cap-fill" style="font-size:20px"></i>
                           Career 
                        </li>
                        <li class="header__shipping--text text-white d-sm-2-none">
                           <i class="ri-mail-line" style="font-size:20px;font-weight:bold"></i> 
                           <a class="header__shipping--text__link" href="mailto:demo@gmail.com">contact@shingavijewellers.com</a>
                        </li>
                     </ul>
                  </div>
                     ...
                     <ul class="d-flex align-items-center">
                        <li class="language__currency--list">
                           <a class="language__switcher text-white" href="#">
                              <!-- <img class="language__switcher--icon__img" src="<?= base_url() ?>public/user_assets/assets/img/icon/language-icon.png" alt="currency"> -->
                           ...
                           <div class="dropdown__language">
                              <ul>
                                 <li class="language__items"><a class="language__text" href="#">Gold 24CT/10g :  <b> &#8377; 71595</b></a></li>
                                 <li class="language__items"><a class="language__text" href="#">GOLD 22CT/10g : <b> &#8377; 67,300/-</b> </a></li>
                                 <li class="language__items"><a class="language__text" href="#">GOLD 18CT/10g : <b> &#8377; 57,992/- </b></a></li>
                                 <li class="language__items"><a class="language__text" href="#">SILVER/10g : <b> &#8377; 885/-</b> </a></li>
                              </ul>
                           </div>
                        </li>
                        <li class="language__currency--list">
                           ...
                           <i class="ri-feedback-line" style="font-size:20px"></i> &nbsp; Feedback
                           </span> 
                           </a>
                        </li>
                        <li class="header__shipping--text text-white d-sm-2-none">
                           <a class="header__shipping--text__link" href="mailto:demo@gmail.com">
                              <i class="ri-whatsapp-line" style="font-size:20px"></i></a>
                        </li>
                        <li class="header__shipping--text text-white d-sm-2-none">
                           <a class="header__shipping--text__link" href="mailto:demo@gmail.com">
                           <i class="ri-instagram-line" style="font-size:20px"></i></a>
                        </li> 
                        <li class="header__shipping--text text-white d-sm-2-none">
                           <a class="header__shipping--text__link" href="mailto:demo@gmail.com">
                           <i class="ri-facebook-line" style="font-size:20px;font-weight:bold"></i>
                           </a>
                        </li> 
                  ...
                  <div class="header__menu d-none header__sticky--block d-lg-block">
                     <nav class="header__menu--navigation">
                        <ul class="d-flex">
                              ...
                              <ul class="header__mega--menu d-flex">
                                 <li class="header__mega--menu__li" >
                                    <ul class="header__mega--sub__menu" style="width:20%">
                                       ...
                                       <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-list.html">Magalesutre</a></li>
                                       <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-list.html">Nath</a></li>
                           ...
                           <li class="header__menu--items style2">
                              <a class="header__menu--link" href="<?= base_url() ?>usercontroller/about">About US </a>  
                           </li>
                           <li class="header__menu--items style2">
                              ...
                              <ul class="header__mega--menu d-flex">
                                 <li class="header__mega--menu__li">
                                    <ul class="header__mega--sub__menu">
                                       ...
                                       <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-list.html">Mangalsutra</a></li>
                                       <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-list.html">Nath</a></li>
                                       <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-list.html">Coin</a></li>
                                    </ul>
                                 </li>
         ...
         <div class="offcanvas__header">
            <div class="offcanvas__inner">
               <div class="offcanvas__logo">
                  ...
                  <img src="https://www.shingavijewellers.com/image/logoblack4.png" alt="Grocee Logo" width="88" height="88">
                  </a>
               ...
               <nav class="offcanvas__menu">
                  <ul class="offcanvas__menu_ul">
                     <li class="offcanvas__menu_li">
                        <a class="offcanvas__menu_item" href="<?= base_url() ?>usercontroller/">Home</a>
                     </li>
                     <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                           ...
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Chain Pendents</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Necklaes</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Mangalesutre</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Nath</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Coin</a>
                           </li>
                     ...
                     <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                           ...
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Challa</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Pendents</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Silver Utensils</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Pooja Saman</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Payal</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Murti</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Sliver Ear Rings</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Chain</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Bichhya</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Necklaes</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Rakhi</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Krishna Janmashtami</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Cufflinks</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Show Piece</a>
                           </li>
                           <li class="offcanvas__sub_menu_li">
                              <a href="#" class="offcanvas__sub_menu_item">Watches</a>
                           </li>
