<?php
defined("BASEPATH") or exit("no direct script access allowed directly");
?>

<main class="main__content_wrapper">

<!-- Start breadcrumb section -->
<section class="breadcrumb__section breadcrumb__bg" style="background:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('https://www.krishnajewellers.com/blog/wp-content/uploads/2021/07/RV_10-1100x734.jpg');background-repeat:no-repeat;background-size:cover;height:50rem">
    <div class="container">
        ...
        <div class="shipping__section2--inner shipping__style3--inner d-flex justify-content-between">
            <div class="shipping__items2 d-flex align-items-center">
                <div class="shipping__items2--icon">
                    <img src="<?= base_url() ?>public/user_assets/assets/img/other/shipping1.png" alt="">
                </div>
            ...
            <div class="shipping__items2 d-flex align-items-center">
                <div class="shipping__items2--icon">
                    <img src="<?= base_url() ?>public/user_assets/assets/img/other/shipping2.png" alt="">
                </div>
                <div class="shipping__items2--content">
            ...
            <div class="shipping__items2 d-flex align-items-center">
                <div class="shipping__items2--icon">
                    <img src="<?= base_url() ?>public/user_assets/assets/img/other/shipping3.png" alt="">
                </div>
                <div class="shipping__items2--content">
            ...
            <div class="shipping__items2 d-flex align-items-center">
                <div class="shipping__items2--icon">
                    <img src="<?= base_url() ?>public/user_assets/assets/img/other/shipping4.png" alt="">
                </div>
                <div class="shipping__items2--content">
