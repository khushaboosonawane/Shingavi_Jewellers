...
<main class="main__content_wrapper">
        ...
        <section class="breadcrumb__section breadcrumb__bg" style="background:linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url('https://sjewelryfashion.com/public/upload/65d8535a4c31f.webp');height:45rem;background-size:cover;background-repeat:no-repeat;background-position:center center">
            <div class="container">
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <h1 class="breadcrumb__content--title text-white mb-25">Neckales</h1>
                ...
                <div class="row row-cols-lg-2 row-cols-md-2">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="https://shingavijewellers.com//uploads/product-1680157343-15412.jpg"><img class="product__media--preview__items--img" src="https://shingavijewellers.com//uploads/product-1680157343-15412.jpg" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="https://shingavijewellers.com//uploads/product-1680157343-15412.jpg" data-gallery="product-media-preview">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="https://emcgtdx36wv.exactdn.com/wp-content/uploads/2023/08/KNA933-6330.png?lossy=0&webp=90&avif=90&ssl=1"><img class="product__media--preview__items--img" src="https://emcgtdx36wv.exactdn.com/wp-content/uploads/2023/08/KNA933-6330.png?lossy=0&webp=90&avif=90&ssl=1" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="https://emcgtdx36wv.exactdn.com/wp-content/uploads/2023/08/KNA933-6330.png?lossy=0&webp=90&avif=90&ssl=1" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="https://i.pinimg.com/736x/77/5b/5a/775b5abeaa6bffcda339cca6f9649218.jpg"><img class="product__media--preview__items--img" src="https://i.pinimg.com/736x/77/5b/5a/775b5abeaa6bffcda339cca6f9649218.jpg" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="https://i.pinimg.com/736x/77/5b/5a/775b5abeaa6bffcda339cca6f9649218.jpg">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="https://shingavijewellers.com//uploads/product-1680157343-15412.jpg" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="https://emcgtdx36wv.exactdn.com/wp-content/uploads/2023/08/KNA933-6330.png?lossy=0&webp=90&avif=90&ssl=1" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="https://i.pinimg.com/736x/77/5b/5a/775b5abeaa6bffcda339cca6f9649218.jpg" alt="product-nav-img">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col">
                        <div class="product__details--info">
                            <form action="#">
                                <h2 class="product__details--info__title mb-15">Neckales</h2>
                                ...
                                <div class="product__variant">
                                    ...
                                    <div class="product__variant--list quantity d-flex align-items-center mb-20 my-3">
                                ...
                                <div class="guarantee__safe--checkout">
                                    ...
                                    <img class="guarantee__safe--checkout__img" src="<?= base_url() ?>public/user_assets/assets/img/other/safe-checkout.png" alt="Payment Image">
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <div id="description" class="tab_pane active show">
                                    <div class="product__tab--content">
                                        <div class="product__tab--content__step mb-30">
                                            <h2 class="product__tab--content__title h4 mb-10">Neckales</h2>
                                        ...
                                        <div class="reviews__comment--area">
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="<?= base_url() ?>public/user_assets/assets/img/other/comment-thumb1.png" alt="comment-thumb">
                                                </div>
                                            ...
                                            <div class="reviews__comment--list margin__left d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="<?= base_url() ?>public/user_assets/assets/img/other/comment-thumb2.png" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
                                            ...
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="<?= base_url() ?>public/user_assets/assets/img/other/comment-thumb3.png" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
